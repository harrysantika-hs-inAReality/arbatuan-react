 ...
 */
export const getSingleAnimation = (props) => {
    let animationKey = '';
...
const getAnimationParams = (props) => {
    if (!_.isArray(props))
        return [getSingleAnimation(props)];
 ...
 * @returns animationParams
 */
export const getMultipleAnimation = (props) => {
    const params = getAnimationParams(props);
    const animations = _.reduce(params, (acc, curr, index) => ({
        ...acc,
...
export const convertObjectToString = (props) => {
    _.forEach(props, (value, key) => {
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const getAframeProps = (props) => {
